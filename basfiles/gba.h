...
///// MOSAIC
#define MOSAIC_BG_H(x) (x&0xf)
#define MOSAIC_BG_V(x) ((x&0xf)<<4)
#define MOSAIC_OBJ_H(x) ((x&0xf)<<8)
#define MOSAIC_OBJ_V(x) ((x&0xf)<<12)
...
// 15bitの色を表現するマクロ
#define RGB(r, g, b) ((((u16)(b) & 0x1f) << 10) | (((u16)(g) & 0x1f) << 5) | (((u16)(r) & 0x1f) << 0))
